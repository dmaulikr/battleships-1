...
+ (instancetype)twitterShape
{
    ...
    [nPath addCurveToPoint: CGPointMake(34.23, 54.93)
			 controlPoint1: CGPointMake(26.32, 56.63)
			 controlPoint2: CGPointMake(30.38, 56.06)];
	
    [nPath addCurveToPoint: CGPointMake(44.42, 50.27)
			 controlPoint1: CGPointMake(38.08, 53.8)
			 controlPoint2: CGPointMake(41.48, 52.25)];
	
    [nPath addCurveToPoint: CGPointMake(52.37, 43.37)
			 controlPoint1: CGPointMake(47.36, 48.29)
			 controlPoint2: CGPointMake(50.01, 45.99)];
	
    [nPath addCurveToPoint: CGPointMake(58.2, 34.89)
			 controlPoint1: CGPointMake(54.74, 40.75)
			 controlPoint2: CGPointMake(56.68, 37.92)];
